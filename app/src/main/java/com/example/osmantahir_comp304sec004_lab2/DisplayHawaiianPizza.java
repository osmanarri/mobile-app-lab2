...
public class DisplayHawaiianPizza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_hawaiian_pizza);

        // Get the Intent that started this activity and extract the string
        Intent intent = getIntent();

        String messageToppingType = "Hawaiian Pizza";  //Change Here #######################
        String messageToppingName = intent.getStringExtra(HawaiianPizzaToppings.ToppingName);  //Change Here #######################
        ...
        btnDisplay3 = (Button) findViewById(R.id.button5);
