...
public class VeggieLoverToppings extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_veggie_lover_toppings);

        // Action bar
        ActionBar actionBar =getSupportActionBar();
        actionBar.setTitle("Veggie Lover's Toppings");
    }
    ...
    public void goToDisplayChoiceA(View view) {    //Change Here
        Intent intent = new Intent(this, DisplayVeggieLoverPizza.class);  //Change Here

        String checkedToppingsName="";

        CheckBox chkBxH1= (CheckBox) findViewById(R.id.checkGreenPepper);    //Change Here
        ...
        if(chkBxH1.isChecked()){checkedToppingsName=checkedToppingsName + getString(R.string.green_pepper)+"\n\n";}    //Change Here
        if(chkBxH2.isChecked()){checkedToppingsName=checkedToppingsName + getString(R.string.Olives)+"\n\n";}    //Change Here
